...
import com.idp.system.entity.SysUser;
...
public class ExceptionHandle {
	...
	public void logException(HttpServletRequest request, HttpServletResponse response, Exception e)
			throws Exception {
		...
		sysLogService.add(new SysLog(SysLog.MENU_ERROR, request.getRequestURL().toString(),
				errorMessage, operateUser, request.getRemoteAddr(), new Date()));
